		...
		<nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
			<div class="px-5 py-2">
				<a
					sveltekit:prefetch
					href="/"
					class="underline text-base text-gray-600 hover:text-orange-500"
				>
					Home
				</a>
			</div>
			...
			<div class="px-5 py-2">
				<a
					...
					target="_blank"
					href="https://twitter.com/moscowtime_xyz"
					class="underline text-base text-gray-600 hover:text-orange-500"
				>
					Twitter bot
				</a>
			...
			<div class="px-5 py-2">
				<a
					rel="external noopener"
					target="_blank"
					href="https://coinos.io/moscowtime"
					class="underline text-base text-gray-600 hover:text-orange-500"
				>
					Donate sats
				</a>
